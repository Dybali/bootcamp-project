...
public class ApplicantBusinessRules {
    ...
    public void checkIfNationalityIdentityExists(String nationalityIdentity) {
        ...
        if (existingApplicant.isPresent()) {
            throw new RuntimeException("Bu TC kimlik numarası ile zaten kayıtlı bir başvuru sahibi bulunmaktadır.");
        }
    }
    ...
    public void checkIfBlacklisted(Long applicantId) {
        ...
        if (blacklistEntry.isPresent()) {
            throw new RuntimeException("Bu başvuru sahibi kara listede bulunmaktadır. Başvuru yapamaz.");
        }
    }
    ...
    public void checkIfApplicantExists(Long applicantId) {
        ...
        if (applicant.isEmpty()) {
            throw new RuntimeException("Sistemde kayıtlı olmayan başvuru sahibi ID'si: " + applicantId);
        }
    }
} 
