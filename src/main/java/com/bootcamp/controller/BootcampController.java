...
public class BootcampController {
    ...
    @PostMapping
    public BootcampResponse create(@Valid @RequestBody BootcampCreateRequest request) {
    ...
    @PutMapping("/{id}")
    public BootcampResponse update(@PathVariable Long id, @Valid @RequestBody BootcampCreateRequest request) {
