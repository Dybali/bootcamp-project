...
public class InstructorController {
    ...
    @PostMapping
    public InstructorResponse create(@Valid @RequestBody InstructorCreateRequest request) {
    ...
    @PutMapping("/{id}")
    public InstructorResponse update(@PathVariable Long id, @Valid @RequestBody InstructorCreateRequest request) {
